                        ...
                        ?>
                            <tr>
                                ...
                                <td class='text-center'>
                                    <a href="?page=edit&sid=<?= $data[$x]['id']; ?>" title="Muuda seda postitust!">
                                        <i class="fa-solid fa-pen text-success me-2"></i>
                                    </a>
                                    <a href="?page=post_edit&sid=<?= $data[$x]['id'] ?>&delete=true" onClick="return confirm('Kas oled kindel, et soovid kustutada?');">
